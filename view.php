...
<body>
   ...
   <?php 
    ...
    {  ?>
            ...
            <h1><?php echo $rows['author'];?></h1>
                <h1><?php echo $rows['title'];?></h1>

                <div class="d-flex mt-2 justify-content-center align-items-center">
                    <a href="edit.php?id=<?php echo $rows['id']?>" class="btn btn-light btn-sm" name="edit">Edit</a>
                    <form method="POST">
            ...
            <p class="mt-5 border-left border-dark pl-3"><?php echo $rows['content'];?></p>
        <?php } ?>    
